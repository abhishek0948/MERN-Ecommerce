...
const PaymentSuccess = () => {
  return (
    <div className="bg-slate-200 rounded-md my-4 min-h-[calc(100vh-160px)] mx-auto w-full max-w-md flex justify-center  items-center flex-col">
      ...
      <Link to={'/order'} className="p-2 px-3 mt-8 rounded font-semibold text-green-600 border-2 border-green-600 hover:bg-green-600 hover:text-white transition-all">See Order</Link>
    </div>
  );
};
